...
use IMS;
CREATE TABLE Customer (customer_id int NOT NULL AUTO_INCREMENT, first_name varchar(20), 
last_name varchar(20), email varchar(20), phone_num int, CONSTRAINT PK_Customer PRIMARY KEY (customer_id));

CREATE TABLE Item (item_id int NOT NULL AUTO_INCREMENT, item_name varchar(20), size int,
 price int, stock int, CONSTRAINT PK_ITEM PRIMARY KEY (item_id));
...
CREATE TABLE Item_Order (order_id int NOT NULL , item_id int NOT NULL, quantity int,
